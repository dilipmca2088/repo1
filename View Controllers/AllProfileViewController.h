...
@interface AllProfileViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,UIImagePickerControllerDelegate,UIPickerViewDelegate,UIPickerViewDataSource,ELCImagePickerControllerDelegate, UINavigationControllerDelegate, UIScrollViewDelegate>
{
    ...
    IBOutlet JVFloatLabeledTextField *vendorNameTF;
    IBOutlet JVFloatLabeledTextField *vendoremailTF;
    IBOutlet JVFloatLabeledTextField *vendorstateTF;
    IBOutlet JVFloatLabeledTextField *vendorcityTF;
    IBOutlet JVFloatLabeledTextField *vendorcountryTF;
    //IBOutlet JVFloatLabeledTextField *vendorpinTF;
    IBOutlet JVFloatLabeledTextField *vendorAdd;
...
@property(strong,nonatomic)NSString *frmEditStr;
...
@property (weak, nonatomic) IBOutlet UIScrollView *vendorscrollView;
@property (weak, nonatomic) IBOutlet UIScrollView *centrescrollView;
