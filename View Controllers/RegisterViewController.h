...
@interface RegisterViewController : UIViewController<UITableViewDelegate,UITableViewDataSource,UIImagePickerControllerDelegate,UIPickerViewDelegate,UIPickerViewDataSource>
{
    IBOutlet JVFloatLabeledTextField *firstNameTF;
    IBOutlet JVFloatLabeledTextField *pswdTF;
    IBOutlet JVFloatLabeledTextField *conpswdTF;
    IBOutlet JVFloatLabeledTextField *postaddTF;
    IBOutlet JVFloatLabeledTextField *emailTF;
    IBOutlet JVFloatLabeledTextField *sexTF;
    IBOutlet JVFloatLabeledTextField *stateTF;
    IBOutlet JVFloatLabeledTextField *cityTF;
    IBOutlet JVFloatLabeledTextField *countryTF;
    IBOutlet JVFloatLabeledTextField *pinTF;
